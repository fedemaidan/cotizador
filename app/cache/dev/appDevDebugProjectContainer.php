...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'bui_service' => 'getBuiServiceService',
            ...
            'importacion_service' => 'getImportacionServiceService',
            ...
            'primary_service' => 'getPrimaryServiceService',
            ...
            'slik_dompdf' => 'getSlikDompdfService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EnseparHtml2pdfBundle', ($this->targetDirs[2].'/Resources/EnseparHtml2pdfBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EnseparHtml2pdfBundle', ($this->targetDirs[3].'/vendor/ensepar/html2pdf-bundle/Ensepar/Html2pdfBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SlikDompdfBundle', ($this->targetDirs[2].'/Resources/SlikDompdfBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SlikDompdfBundle', ($this->targetDirs[3].'/vendor/slik/dompdf-bundle/Slik/DompdfBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSJsRoutingBundle', ($this->targetDirs[2].'/Resources/FOSJsRoutingBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSJsRoutingBundle', ($this->targetDirs[3].'/vendor/friendsofsymfony/jsrouting-bundle/FOS/JsRoutingBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    /**
     * Gets the 'bui_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\BUIService A AppBundle\Service\BUIService instance.
     */
    protected function getBuiServiceService()
    {
        return $this->services['bui_service'] = new \AppBundle\Service\BUIService($this, $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'cotizacion_permisos', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a4cdb6da3beeee918287a87728a4502e361816901fc3a1c60757abcb7bd1bdfb');
    ...
    /**
     * Gets the 'html2pdf_factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Ensepar\Html2pdfBundle\Factory\Html2pdfFactory A Ensepar\Html2pdfBundle\Factory\Html2pdfFactory instance.
     */
    ...
    /**
     * Gets the 'importacion_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\ImportacionService A AppBundle\Service\ImportacionService instance.
     */
    protected function getImportacionServiceService()
    {
        return $this->services['importacion_service'] = new \AppBundle\Service\ImportacionService($this, $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'primary_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\CotizadorService A AppBundle\Service\CotizadorService instance.
     */
    protected function getPrimaryServiceService()
    {
        return $this->services['primary_service'] = new \AppBundle\Service\CotizadorService($this, $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'slik_dompdf' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Slik\DompdfBundle\Wrapper\DompdfWrapper A Slik\DompdfBundle\Wrapper\DompdfWrapper instance.
     */
    protected function getSlikDompdfService()
    {
        return $this->services['slik_dompdf'] = new \Slik\DompdfBundle\Wrapper\DompdfWrapper();
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('cf2b924a65f5cea2e725767da93cc6dc2517f02d');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('575840493920a6.48547611')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'cotizacion_permisos',
            'database_user' => 'root',
            ...
            'secret' => 'cf2b924a65f5cea2e725767da93cc6dc2517f02d',
            'version' => '0.2',
            'bui_api' => 'http://10.73.100.59:6748/service/api/BUI/',
            'user_bui' => 'rmonicat',
            'password_bui' => '2016052313407118',
            ...
            'kernel.secret' => 'cf2b924a65f5cea2e725767da93cc6dc2517f02d',
            ...
            'assetic.bundles' => array(
                ...
                8 => 'AsseticBundle',
                9 => 'KnpSnappyBundle',
                10 => 'EnseparHtml2pdfBundle',
                11 => 'SlikDompdfBundle',
                12 => 'FOSJsRoutingBundle',
                13 => 'DoctrineMigrationsBundle',
                14 => 'DebugBundle',
